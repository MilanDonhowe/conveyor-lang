...
# The Program Queue class needs to be modularized into its own file...
# Same with the Numeric_queues class...
...
# The Queue "Conveyor Belt" --> holds list of Tokens. :)
...
if __name__ == "__main__":
    ...
    main, func_table = read_program(program_text)

    #print (func_table.keys())
    ...
    if (len(argv) > 2):
        ...
        for x in func_table.keys():
            ...
            print_tokens(func_table[x])

    PQ = Program_Queue(main, func_table)
